...
do
mkdir -p /store/scratch/y247xie/00_data/wp-tokenized-anserini/${corpora}/corpus
mv /store/scratch/y247xie/00_data/wp-tokenized-anserini/${corpora}/corpus.jsonl /store/scratch/y247xie/00_data/wp-tokenized-anserini/${corpora}/corpus/
mkdir -p /store/scratch/y247xie/00_data/wp-tokenized-anserini/${corpora}/queries
mv /store/scratch/y247xie/00_data/wp-tokenized-anserini/${corpora}/queries.jsonl /store/scratch/y247xie/00_data/wp-tokenized-anserini/${corpora}/queries/
...
do
mkdir -p /store/scratch/y247xie/00_data/wp-tokenized-anserini/cqadupstack/${corpora}/corpus
mv /store/scratch/y247xie/00_data/wp-tokenized-anserini/cqadupstack/${corpora}/corpus.jsonl /store/scratch/y247xie/00_data/wp-tokenized-anserini/cqadupstack/${corpora}/corpus/
mkdir -p /store/scratch/y247xie/00_data/wp-tokenized-anserini/cqadupstack/${corpora}/queries
...
python tokenize_queries.py \
	...
	--output /store/scratch/y247xie/00_data/wp-tokenized-anserini/cqadupstack/${corpora}/queries/queries.jsonl
done
